...
*   **F07: Manage Attendance Session:** Start the session, display dynamic QR (10s refresh) and PIN (30s refresh), and finalize the result.
...
*   **NF-06 Maintainability:**
    *   QR refresh interval, PIN refresh interval, and Late threshold must be configurable without changing source code.
...
| **Priority:**          | High                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Business Rules:**    | BR-02, BR-03, BR-04, BR-05, BR-12, BR-13                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| **Priority:**          | High                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Business Rules:**    | BR-02, BR-03, BR-04, BR-05, BR-07, BR-12, BR-13                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
  ...
  if (Is another attendance session already active?) then ([Yes])
    ...
    repeat
      ...
      if (Need manual adjustment?) then ([Yes])
        :Adjust attendance status using UC07;
      else ([No])
      endif
    ...
    |Lecturer|
    :9. Click "Finalize Attendance";

    |System|
    :10. Stop accepting new QR/PIN check-ins;
    :11. Assign Absent to enrolled students\nwithout official Present or Late;
    :12. Mark attendance result as finalized;
    :13. Close projector view and return to session dashboard;
  endif
endif
